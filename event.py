...
# 서브 1
sub1_e1 = ['당신은 다음 마을로 건너가기 위해 산을 넘던 도중 수염이 덥수룩한 산적을 마주쳤습니다. "제하하하하! 가진걸 다 내놔라"', 
       "말을 건다", 
       "필살. 공격", 
       "무시한다"]
sub1_e111 = ['']
...
# 서브 2
sub2_e1 = ['마을을 떠나 길을 따라 한참을 걷던 도중 당신은 허기를 느껴 가방에서 먹을 것을 꺼냈습니다. 하지만 쌀쌀한 날씨에 샌드위치는 차게 식어버린 후였습니다.', 
           '"이런, 샌드위치가 다 식어버렸잖아"', 
           '그냥 먹는다']
sub2_e1_11 = ['"호호오우~ 아쎄이!! 내 맛있는 해군 샌드위치를 먹어보게...!"', 
             "악...!", 
             "누구세요?"]
sub2_e1_11_11 = ['"그렇다면 내 함포를... 빠라빠라빠빠빠!"', 
                 '악!!!!!']
